"""
Web Interface for MRO Intelligence Report Generator
Simple, elegant FastAPI application for generating Grainger MRO intelligence reports
"""
...
from mro_intelligence.utils.config import get_output_dir
...
generator: Optional[MROIntelligenceGenerator] = None


def get_generator() -> MROIntelligenceGenerator:
...
app = FastAPI(
    title="MRO Intelligence Report Generator",
    description="Generate monthly MRO market intelligence reports for Grainger from ErgoMind, GTA, and FRED data",
    version="1.0.0",
    lifespan=lifespan,
)
...
def main():
    """Entry point for mro-web CLI command"""
    import uvicorn
