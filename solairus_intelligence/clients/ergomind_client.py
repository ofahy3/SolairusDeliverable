...
async def test_ergomind_client():
    """Test function for the ErgoMind client"""
    
    async with ErgoMindClient() as client:
        # Test connection
        ...
        result = await client.query_websocket(
            "What were the major geopolitical developments in the past month?"
        )
        ...
        queries = [
            "What economic indicators changed significantly this month?",
            "What are the key risks for international business travel?",
            "Summarize technology sector geopolitical impacts"
        ]
...
if __name__ == "__main__":
    # Run the test
    asyncio.run(test_ergomind_client())
