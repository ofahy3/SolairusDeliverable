"""
Content extraction and parsing for Solairus Intelligence Reports.
...
class ContentExtractor:
    ...
    def _generate_contextual_bullets(
        ...
        if "aviation" in text_lower or "flight" in text_lower:
            bullets.append("Review operational routes and contingency plans")
            bullets.append("Assess impact on client travel schedules")
        elif "economic" in text_lower or "market" in text_lower:
            bullets.append("Monitor market indicators for client exposure")
            bullets.append("Review financial planning assumptions")
        elif "regulation" in text_lower or "policy" in text_lower:
            bullets.append("Track regulatory timeline and requirements")
            bullets.append("Assess compliance implications")
        else:
            bullets.append("Continue monitoring developments")
            bullets.append("Assess potential client impact")
